...
if (typeof Musubi_android_platform == "object") {
  ...
  Musubi.platform = {
    ...
    _postObjToFeed: function(obj, session) {
      return Musubi_android_platform._postObjToFeed(JSON.stringify(obj), session);
    },
    _postObjToSubfeed: function(obj, session, parentId) {
      return Musubi_android_platform._postObjToSubfeed(JSON.stringify(obj), session, parentId);
    },
    _urlForRaw: function(objId) {
