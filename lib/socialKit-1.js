...
if (typeof Musubi_android_platform == "object") {
  ...
  Musubi.platform = {
    ...
    _querySubfeed: function(objId, query, sortOrder) {
      return JSON.parse(Musubi_android_platform._querySubfeed(objId, query, sortOrder));
    },
    _postObjToFeed: function(obj, session) {
      return JSON.parse(Musubi_android_platform._postObjToFeed(JSON.stringify(obj), session));
    },
    _postObjToSubfeed: function(obj, session, parentId) {
